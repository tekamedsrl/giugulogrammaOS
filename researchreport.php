...
<html>
   ...
   <?php session_start();
    ...
    <body style="width:800px">
        ...
        <h2 style="text-align: center; font-size:18px; font-family: Times New Roman, Georgia, Serif;">ANALISI ULTRASONORA NON INVASIVA DEL POLSO VENOSO GIUGULARE</h1>
            <br><br>
            <div ng-app="appAnag" ng-controller="myCtrl">
                <table >
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class=mtd>
                            ...
                            ?>
                                ...
                                <form>
                                    <p>{{sex}}</p>
                                    <span style="color:red;" ng-show="su">Sesso</span><input type="text" ng-model="bsex" ng-show="su"/> 
                                    <input type="hidden" ng-model="bsid" />
                                    <input type="button" value="Submit" ng-click="insertSexData()" ng-show="su" />
                                </form>
                    ...
                    <tr>
                        ...
                        <td class=mtd>
                            ...
                            ?>
                                <p>{{cf}}</p>
                                <form>
                                    <span style="color:red;" ng-show="su">Codice Fiscale</span><input type="text" ng-model="bcf" ng-show="su"/>
                                    <input type="hidden" ng-model="bsid" />
                                    <!--<input type="button" value="Submit" ng-click="insertCFData()" />-->
                                </form>
                            <?php
                            }
                            else
                    ...
                    <tr>
                        ...
                        <td class=mtd>
                            ...
                            ?>
                                ...
                                <p>{{add}}</p>
                                <form>
                                    <span style="color:red;" ng-show="su">Indirizzo</span><input type="text" ng-model="badd" ng-show="su"/>
                                    <input type="hidden" ng-model="bsid" />
                                    <!--<input type="button" value="Submit" ng-click="insertAddData()" />-->
                                </form>
                            <?php
                            }
                            else
                ...
                <script>
                 var app = angular.module('appAnag',[]);
                 app.controller('myCtrl',function($scope,$http){
                     $scope.bsid = "<?php echo $suid ?>";
                     $scope.cf="";
                     $scope.su="empty";
                     
                     $scope.insertSexData=function(){
                         $scope.su="";
...
$dataObj->cvp_y_sd=round( $stat['d'],2);
	...
	$dataObj->dxcp_m=$c_dxp;
        ...
        // Modifica per ECG on line
        $myecg=getECGwaveform($vid);
        //$min=0;
...
?>
    <!--<div style="font-size:12px;"><b>Diagramma temporale della IJV CSA</b></div>-->
